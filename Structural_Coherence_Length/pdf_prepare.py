...
def main():
    ...
    prep.add('1.0LiCl_Li7Numbers_2026_900.0_AP.csv', "1.0LiCl", 'Li7Numbers, 2026', 900, apply_savgol=False)
    prep.add('1.0LiCl_Li6Numbers_2026_900.0_AP.csv', "1.0LiCl", 'Li6Numbers, 2026', 900, apply_savgol=False)
    prep.add('1.0RbCl_Numbers_2026_1015.0_AP.csv', "1.0RbCl", 'Numbers, 2026', 1015, apply_savgol=False)
    prep.add('0.68KCl-0.32MgCl2_Numbers_2026_903.0_AP.csv', "0.68KCl-0.32MgCl2", 'Numbers, 2026', 903, apply_savgol=False)
    prep.add('0.60LiCl-0.40MgCl2_Numbers_2026_870.0_AP.csv', "0.60LiCl-0.40MgCl2", 'Numbers, 2026', 870, apply_savgol=False)
    prep.add('0.68KCl-0.32MgCl2_Numbers_2026_703.0_AP.csv', "0.68KCl-0.32MgCl2", 'Numbers, 2026', 703, apply_savgol=False)
    prep.add('0.68KCl-0.32MgCl2_Numbers_2026_903.0_AP.csv', "0.68KCl-0.32MgCl2", 'Numbers, 2026', 903, apply_savgol=False)
    prep.add('0.5NaCl-0.5KCl_Numbers_2026_950.0_AP.csv', "0.5NaCl-0.5KCl", 'Numbers, 2026', 950, apply_savgol=False)
    prep.add('0.5LiCl-0.5KCl_Numbers_2026_760.0_AP.csv', "0.5LiCl-0.5KCl", 'Numbers, 2026', 760, apply_savgol=False)
    prep.add('0.56NaCl-0.44MgCl2_Numbers_2026_760.0_AP.csv', "0.56NaCl-0.44MgCl2", 'Numbers, 2026', 760, apply_savgol=False)
    prep.add('0.535NaCl-0.315MgCl2-0.15CaCl2_Numbers_2026_855.0_AP.csv', "0.535NaCl-0.315MgCl2-0.15CaCl2", 'Numbers, 2026', 855, apply_savgol=False)
    prep.add('0.535LiCl-0.086NaCl-0.379KCl_Numbers_2026_650.0_AP.csv', "0.535LiCl-0.086NaCl-0.379KCl", 'Numbers, 2026', 650, apply_savgol=False)
    prep.add('0.4903NaCl-0.5097CaCl2_Numbers_2026_800.0_AP.csv', "0.4903NaCl-0.5097CaCl2", 'Numbers, 2026', 800, apply_savgol=False)
    prep.add('0.43KCl-0.57MgCl2_Numbers_2026_750.0_AP.csv', "0.43KCl-0.57MgCl2", 'Numbers, 2026', 750, apply_savgol=False)
    prep.add('0.33NaCl-0.22KCl-0.45MgCl2_Numbers_2026_750.0_AP.csv', "0.33NaCl-0.22KCl-0.45MgCl2", 'Numbers, 2026', 750, apply_savgol=False)
    prep.add('0.2839NaCl-0.2725KCl-0.4436MgCl2_Numbers_2026_680.0_AP.csv', "0.2839NaCl-0.2725KCl-0.4436MgCl2", 'Numbers, 2026', 680, apply_savgol=False)
    prep.add('0.275NaCl-0.325KCl-0.40MgCl2_Numbers_2026_700.0_AP.csv', "0.275NaCl-0.325KCl-0.40MgCl2", 'Numbers, 2026', 700, apply_savgol=False)
    prep.add('0.25LiCl-0.75KCl_Numbers_2026_934.0_AP.csv', "0.25LiCl-0.75KCl", 'Numbers, 2026', 934, apply_savgol=False)
    prep.add('0.21NaCl-0.41KCl-0.38MgCl2_Numbers_2026_680.0_AP.csv', "0.21NaCl-0.41KCl-0.38MgCl2", 'Numbers, 2026', 680, apply_savgol=False)

    prep.add('0.637LiCl-0.363KCl_Numbers_2026_690.0_AP.csv', "0.637LiCl-0.363KCl", 'Numbers, 2026', 690, apply_savgol=False)
    prep.add('1.0CaCl2_Numbers_2026_1060.0_AP.csv', "1.0CaCl2", 'Numbers, 2026', 1060, apply_savgol=False)
    prep.add('1.00CsCl_Numbers_2026_935.0_AP.csv', "1.00CsCl", 'Numbers, 2026', 935, apply_savgol=False)
    prep.add('1.00LiCl_900.0K_unweighted_PDF.csv', "1.0LiCl", 'Numbers, 2026', 900, apply_savgol=False)
    prep.add('1.00NaCl_Numbers_2026_1090.0_AP.csv', "1.00NaCl", 'Numbers, 2026', 1090, apply_savgol=False)
    prep.add('1.00MgCl2_Numbers_2026_1000.0_AP.csv', "1.00MgCl2", 'Numbers, 2026', 1000, apply_savgol=False)
    prep.add('1.00KCl_Numbers_2026_1060.0_AP.csv', "1.00KCl", 'Numbers, 2026', 1060, apply_savgol=False)



    # prep.add('1.0KCl_Walker_2026_1043.0_AP.csv', "1.0KCl", 'Walker, 2026', 1043, apply_savgol=False)
    # prep.add('1.0MgCl2_Walker_2026_987.0_AP.csv', "1.0MgCl2", 'Walker, 2026', 987, apply_savgol=False)
    # prep.add('0.32MgCl2-0.68KCl_Walker_2026_723.0_AP.csv', "0.32MgCl2-0.68KCl", 'Walker, 2026', 723, apply_savgol=False)
    # prep.add('0.718KCl-0.282CaCl2_Walker_2026_921.0_AP.csv', "0.718KCl-0.282CaCl2", 'Walker, 2026', 921, apply_savgol=False)
    # prep.add('0.5NaCl-0.5KCl_Walker_2026_1100.0_AP.csv', "0.5NaCl-0.5KCl", 'Walker, 2026', 1100, apply_savgol=False)
    # prep.add('0.21NaCl-0.41KCl-0.38MgCl2_Walker_2026_660.0_AP.csv', "0.21NaCl-0.41KCl-0.38MgCl2", 'Walker, 2026', 660, apply_savgol=False)
    # prep.add('0.3NaCl-0.7KCl_Walker_2026_1100.0_AP.csv', "0.3NaCl-0.7KCl", 'Walker, 2026', 1100, apply_savgol=False)
    # prep.add('0.6NaCl-0.4KCl_Walker_2026_1100.0_AP.csv', "0.6NaCl-0.4KCl", 'Walker, 2026', 1100, apply_savgol=False)
    # prep.add('0.5LiCl-0.5KCl_NumbersNVE_2026_738.0_AP.csv', "0.5LiCl-0.5KCl", 'NumbersNVE, 2026', 738, apply_savgol=False)
    # prep.add('0.5LiCl-0.5KCl_NumbersNVT_2026_738.0_AP.csv', "0.5LiCl-0.5KCl", 'NumbersNVT, 2026', 738, apply_savgol=False)
