...
def main():
    ...
    # prep.add('1.0KCl_Walker_2026_1043.0_AP.csv', "1.0KCl", 'Walker, 2026', 1043, apply_savgol=True)
    # prep.add('1.0MgCl2_Walker_2026_987.0_AP.csv', "1.0MgCl2", 'Walker, 2026', 987, apply_savgol=True)
    # prep.add('0.32MgCl2-0.68KCl_Walker_2026_723.0_AP.csv', "0.32MgCl2-0.68KCl", 'Walker, 2026', 723, apply_savgol=True)
