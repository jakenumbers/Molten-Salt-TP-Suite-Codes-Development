...
#SBATCH --output=slurm_pr_%j.out
#SBATCH --time=03:00:00                
#SBATCH --nodes=1
#SBATCH --ntasks=1
#SBATCH --cpus-per-task=1          # <--- INCREASED from 1 to speed up neighbor lists
...
python "$PROJECT_ROOT/Pipeline/run_pr_pipeline.py" --comp $COMP --temp $TEMP --model "$PROJECT_ROOT/SuperSalt-swa.model"
